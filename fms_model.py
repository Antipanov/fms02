...
def fight_map():
  ...
  total_round_qty = len(weight_category_rounds_data)
  print(weight_category_rounds_data)
  print("кол-во раундов: ", total_round_qty)
  return total_round_qty, weight_category_rounds_data